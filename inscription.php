...
try {
    ...
    if ($checkStmt->rowCount() > 0) {
        ...
        $sql = "INSERT INTO utilisateur (nom, prenom, mail, mot_de_passe, ville, isClient) VALUES (:nom, :prenom, :email, :mot_de_passe, :ville, :,IsClient)";
        ...
        $stmt->bindParam(':IsClient', $IsClient);
